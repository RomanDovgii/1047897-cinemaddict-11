...
const commentedMoviesToRender = 2;
const ratedMoviesToRender = 2;
...
for (let i = 0; i < moviesToRender; i++) {
  render(filmsContainer, createMovieCard(), Positions.BEFORE_END);
}
...
for (let i = 0; i < ratedMoviesToRender; i++) {
  render(topRatedContainer, createMovieCard(), Positions.BEFORE_END);
}
